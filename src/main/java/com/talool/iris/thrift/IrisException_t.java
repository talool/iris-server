...
public class IrisException_t extends TException implements org.apache.thrift.TBase<IrisException_t, IrisException_t._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("IrisException_t");
  ...
  static {
    schemes.put(StandardScheme.class, new IrisException_tStandardSchemeFactory());
    schemes.put(TupleScheme.class, new IrisException_tTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(IrisException_t.class, metaDataMap);
  }

  public IrisException_t() {
  }
   ...
   */
  public IrisException_t(IrisException_t other) {
  ...
  public IrisException_t deepCopy() {
    return new IrisException_t(this);
  }
  ...
  public IrisException_t setErrorCode(int errorCode) {
    this.errorCode = errorCode;
    setErrorCodeIsSet(true);
    return this;
  }
  ...
  public IrisException_t setErrorDesc(String errorDesc) {
    this.errorDesc = errorDesc;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof IrisException_t)
      return this.equals((IrisException_t)that);
    return false;
  }

  public boolean equals(IrisException_t that) {
    if (that == null)
      return false;
  ...
  public int compareTo(IrisException_t other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    IrisException_t typedOther = (IrisException_t)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("IrisException_t(");
    boolean first = true;
  ...
  private static class IrisException_tStandardSchemeFactory implements SchemeFactory {
    public IrisException_tStandardScheme getScheme() {
      return new IrisException_tStandardScheme();
    }
  }

  private static class IrisException_tStandardScheme extends StandardScheme<IrisException_t> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, IrisException_t struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, IrisException_t struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class IrisException_tTupleSchemeFactory implements SchemeFactory {
    public IrisException_tTupleScheme getScheme() {
      return new IrisException_tTupleScheme();
    }
  }

  private static class IrisException_tTupleScheme extends TupleScheme<IrisException_t> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, IrisException_t struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, IrisException_t struct) throws org.apache.thrift.TException {
